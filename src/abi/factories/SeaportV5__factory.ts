...
export class SeaportV5__factory {
  static readonly abi = _abi;
  static createInterface(): SeaportV5Interface {
    return new utils.Interface(_abi) as SeaportV5Interface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): SeaportV5 {
    return new Contract(address, _abi, signerOrProvider) as SeaportV5;
  }
}
